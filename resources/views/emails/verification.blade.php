    ...
    <div
      ...
      ">
        <header>
            <table style="width: 100%;">
                <tbody>
                    <tr style="height: 0;">
                        <td>
                            <img alt="" src="https://santa.3dhdesign.com/assets/images/secret-santa-logo.png"
                                height="60px" />
                        </td>
                        <td style="text-align: right;">
                            <span style="font-size: 16px; line-height: 30px; color: #ffffff;">FROM SANTA</span>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <main>
          ...
          ">
              ...
              ">
                        ...
                        to complete the procedure to change your account password. OTP is
                        valid for
          ...
          ">
                Need help? Ask at
                <a href="mailto:santa@3dhdesign.com"
                    style="color: #499fb6; text-decoration: none;">santa@3dhdesign.com</a>
                or visit our
        ...
        ">
            ...
            color: #434343;
          ">
                Secret Santa | 3DH Design
            </p>
            <p style="margin: 0; margin-top: 8px; color: #434343;">
                No.12 Siri Dhamma Mawatha, Colombo 00700.
            </p>
            ...
            <p style="margin: 0; margin-top: 16px; color: #434343;">
                Copyright © 2023 3DH Design | Secret Santa. All rights reserved.
            </p>
        </footer>
    </div>
</body>
